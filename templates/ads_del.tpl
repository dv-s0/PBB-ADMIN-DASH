...
<button type="button" class="btn btn-success"><a style=" color: #fff; text-decoration: none; " href="index.php?page=ads&amp;del=1&amp;start=1&amp;id={$Inf['id']}">{$lang['yes']}</a></button>
<button type="button" class="btn btn-danger"><a style=" color: #fff; text-decoration: none; " href="index.php?page=ads&amp;control=1&amp;main=1">{$lang['no']}</a>	</button>			
</div>
</div>
