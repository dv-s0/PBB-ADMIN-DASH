...
<h4 class="card-header text-center f16b text-primary">{$lang['edit']} : {$AwardEdit['award']}</h4>
<div class="card-body">
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['title_award']}</span>
</div>
<input class=" form-control f12r" type="text" name="award" value="{$AwardEdit['award']}" size="24" />
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['mem_name']}</span>
</div>
<input  class=" form-control f12r" type="text" name="username" value="{$AwardEdit['username']}" size="24" />
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['Image_Path_award']}</span>
</div>
<input class=" form-control f12r" type="text" name="award_path" value="{$AwardEdit['award_path']}" size="60" />
</div>
