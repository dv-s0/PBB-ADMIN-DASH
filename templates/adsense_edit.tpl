...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=adsense&amp;control=1&amp;main=1">{$lang['adsense']}</a>
</li>
    <li class="breadcrumb-item mt-2 active" aria-current="page">{$lang['adsense']}
</li>
<li class="breadcrumb-item mt-2 active" aria-current="page">{$lang['edit']} :
 {$AdsenseEdit['name']}
</li>
  </ol>
</nav>
...
<input class="  form-control f12r" name="name" id="input_name" value="{$AdsenseEdit['name']}" size="30" type="text">
</div>
<p>{$lang['Enter_the_ad_code']}</p>
<p>{$lang['Writable_Bocuad_Html']}</p>
<textarea class="  form-control f12r mb-3" name="text" id="textarea_text" rows="15" cols="115" wrap="virtual" dir="ltr">{$AdsenseEdit['adsense']}</textarea>
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_downfoot">{$lang['downfoot']}</label>
	
</div>
<select class=" custom-select"  name="downfoot" id="select_downfoot">
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_all_page">{$lang['all_page']}</label>
	
</div>
<select class=" custom-select" name="all_page" id="select_all_page">
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_between_replys">{$lang['between_replys']}</label>
	
</div>
<select  class=" custom-select"  name="between_replys" id="select_between_replys">
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_down_topic">{$lang['down_topic']}</label>
	
</div>
<select class=" custom-select"  name="down_topic" id="select_down_topic">
...
<div class="input-group-prepend">
  ...
  {if {$AdsenseEdit['in_page']} !=''}
				<input class="  form-control f12r" name="in_page" id="input_in_page" value="{$AdsenseEdit['in_page']}" size="70" type="text" placeholder="{$lang['enter_the_page_link']}">
			    {else}
				<input class="  form-control f12r" name="in_page" id="input_in_page" value="" size="70" type="text" placeholder="{$lang['enter_the_page_link']}">
			    {/if}
</div>
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_mid_topic"> {$lang['mid_topic']}</label>
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_forum"> {$lang['Seen_in_the_Inside_of_the_page_Forums']}</label>
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_topic">{$lang['Seen_in_the_Inside_of_the_page_subjects']}</label>
