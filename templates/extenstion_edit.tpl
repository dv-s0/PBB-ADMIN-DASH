...
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['EXtension']}</span>
</div>
<input  class=" form-control f12r" type="text" name="extension" value="{$Inf['Ex']}" />
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['Maximum_Size_in_KB']}</span>
</div>
<input class=" form-control f12r"  type="text" name="max_size" value="{$Inf['max_size']}" />
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['MIME']}</span>
</div>
<input  class=" form-control f12r" type="text" name="mime_type" value="{$Inf['mime_type']}" />
</div>
</div>
