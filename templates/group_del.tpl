...
<h5>{$lang['Are_you_sure_you_want_Delete']}</h5>
<h6>{$lang['All_members_of_this_group_will_return_to_the_group_members']}</h6>
<button type="button" class="btn btn-success btn-sm"><td class="row1"><a style=" color: #fff; text-decoration: none; " href="index.php?page=groups&amp;del=1&amp;start=1&amp;id={$Inf['id']}">{$lang['yes']}</a></button>
<button type="button" class="btn btn-danger btn-sm"><a style=" color: #fff; text-decoration: none; " href="index.php?page=groups&amp;control=1&amp;main=1">
{$lang['no']}</a></button>
</div>
</div>
