...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=options&amp;time=1&amp;main=1">{$lang['Time_Settings']}</a>
</li>
  </ol>
</nav>
...
<h4 class="card-header text-center f16b text-primary">{$lang['Time_Settings']}</h4>
<div class="card-body f12r">
<p>تعديل عدد ساعات فارق توقيت بلدك من توقيت الخادم</p>
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_time_stamp">ضبط توقيت المنتدى</label>
	
</div>
<select class=" custom-select" name="time_stamp" id="select_time_stamp">
	...
	<p>
	سيقوم بضبط الزمن في الخادم من جديد كلما تعطل الزمن 
<br />
أمثلة لبعض مناطق التوقيت الزمنية :
<br />
Asia/Riyadh - Africa/Cairo - Asia/Baghdad - Asia/Bahrain - Asia/Beirut 
Asia/Damascus - Asia/Dubai - Asia/Gaza - Asia/Jerusalem - Asia/Kuwait 
Asia/Muscat - Asia/Qatar - Asia/Aden - Africa/Algiers - Asia/Amman 
Africa/Dar_es_Salaam - Africa/Djibouti - Africa/Khartoum - Africa/Tunis - 
المرجع: للمزيد عن المناطق الزمنية:
http://php.net/manual/en/timezones.php
	
	</p>
	  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >تعديل المنطقة الزمنية للخادم</span>
</div>
<input class="  form-control f12r" type="text" name="time_offset" id="select_time_offset" value="{$_CONF['info_row']['timeoffset']}" size="30" />
</div>
<p>صيغة الوقت المقدم في كافة صفحات المنتدى</p>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >صيغة الوقت</span>
</div>
<input class="  form-control f12r" type="text" name="time_system" id="select_time_system" value="{$_CONF['info_row']['timesystem']}" size="10" />
</div>
<p>
صيغة التاريخ المعروض في كافة صفحات المنتدى</p>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >صيغة التاريخ</span>
</div>
<input class="  form-control f12r" type="text" name="date_system" id="select_date_system" value="{$_CONF['info_row']['datesystem']}" size="10" />
</div>
</div>
