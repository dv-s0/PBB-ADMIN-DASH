...
<table class="table table-sm table-bordered table-striped  ml-1 f12r" style="width: 99%;">
  <thead>
    <tr class="f12r" align="center">
      <th scope="col"> {$lang['adsense_name']}</th>
      <th scope="col">{$lang['adsense_placead']}</th>
...
<h4 class="card-header text-center f16b text-primary">{$lang['adsense_limit_sections']}</h4>
 <div class="card-body f12r">
 
<div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['adsense_limit_sections_id']}</span>
</div>
	<input class="  form-control f12r" name="adsense_limited_sections" id="input_adsense_limited_sections" value="{$_CONF['info_row']['adsense_limited_sections']}" size="40" type="text">
</div>
