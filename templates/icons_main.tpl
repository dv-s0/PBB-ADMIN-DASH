  ...
  <tbody>
	...
	<tr align="center">
        ...
        <td width="3%"  align="center">
		 <div class="custom-control custom-switch">
  <input type="checkbox" class="custom-control-input" id="customSwitch{$IcnList['id']}" name="check[]" value="{$IcnList['id']}">
  <label class="custom-control-label" for="customSwitch{$IcnList['id']}"></label>
</div>
	  </td>
	</tr>
	{/Des::while}
