...
<button type="button" class="btn btn-success btn-sm"><td class="row1"><a style=" color: #fff; text-decoration: none; " href="index.php?page=lang&amp;del=1&amp;start=1&amp;id={$Inf['id']}">{$lang['yes']}</a></button>
<button type="button" class="btn btn-danger btn-sm"><a style=" color: #fff; text-decoration: none; " href="index.php?page=lang&amp;control=1&amp;main=1">
{$lang['no']}</a></button>
</div>
</div>
