<select class=" custom-select" name="month" id="bd_month">
								...
								<select class=" custom-select" name="day" id="bd_day">
								{if {$Inf['bday_day']} == '01' }
...
<input class=" form-control f12r" name="year" id="bd_year" type="text" size="3" value="{$Inf['bday_year']}" dir="ltr"/>
