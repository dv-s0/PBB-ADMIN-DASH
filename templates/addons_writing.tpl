...
<h4 class="card-header text-center f16b text-primary">{$lang['writing_addon']}</h4>
<div class="card-body">
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  f16b">{$lang['sel_addons']}</label>
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  f16b">{$lang['main_location_place']}</label>
	
</div>
<select class=" custom-select" name="main_place" id="sel_main_place" dir="ltr">
...
<div class="input-group mb-3 input-group-sm f12rb">
<div class="input-group-prepend">
    <label class="input-group-text  f16b">{$lang['Location']}</label>
	
</div>
<select class=" custom-select" name="place_of_hook" id="sel_place_of_hook" dir="ltr">
...
<div class="input-group-prepend">
    <span class="input-group-text  f16b" >{$lang['PHP_Code_as_well_as_private']}</span>
</div>
<textarea class=" form-control f12r" name="phpcode" id="textarea_phpcode" rows="12" cols="56" wrap="virtual" dir="ltr"></textarea>
</div>
</div>
