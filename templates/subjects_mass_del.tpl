...
<div class="card bg-light mx-1 mb-3" >
  <div class="card-header text-center f16b text-primary">{$lang['Section_for_dele_subject']}</div>
  <div class="card-body f11r">
  
  {Des::while}{SectionList}
   <div class="d-block text-center f13b">
<a class="text-danger" href="index.php?page=subject&amp;mass_del=1&amp;confirm=1&amp;id={$SectionList['id']}" target="main">{$SectionList['title']}</a>
</div>
