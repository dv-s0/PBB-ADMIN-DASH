...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"> <a href="index.php?page=template&amp;control=1&amp;main=1">{$lang['templates']}</a></li>
	    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=template&amp;control=1&amp;show=1&amp;id={$StyleInfo['id']}">{$StyleInfo['style_title']}</a></li>
    <li class="breadcrumb-item mt-2 active" aria-current="page"> <a href="index.php?page=template&amp;edit=1&main=1&amp;templateid={$TemplateEdit['templateid']}&amp;styleid={$StyleInfo['id']}">
   {$lang['edit']} :
   {$filename}</a></li>
...
<div class="card bg-light mx-1 mb-3" >
  <div class="card-header text-center f16b text-primary">{$lang['edit']} :
   {$filename}</div>
  <div class="card-body f11r">
    <div class="text-center p-1">
<p class="f13b text-danger d-inline">{$lang['Template_name']}</p>
<h6 class="f12r d-inline">{$filename}</h6>
</div>
  <div class="text-center p-1">
<p class="f13b text-danger d-inline">{$lang['TemplateForStyle']}</p>
<h6 class="f12r d-inline ">{$StyleInfo['style_title']}</h6>
</div>
  <div class="text-center p-1">
<p class="f13b text-danger d-inline">{$lang['Free_on']}</p>
<h6 class="f12r d-inline">{$last_edit}</h6>
</div>
<hr>
<p class="f12b text-center">
لمشاهدة محرر بكامل الشاشة اضغط في محرر ثم اضغط على <kbd>F11</kbd> و للعودة اضغط على <kbd>Esc</kbd> او <kbd>F11</kbd> للخروج من تعديل ملء الشاشة
</p>
<hr>
<textarea id="dk-text" rows="25" cols="80" name="context" id="context" dir="ltr">{$context}</textarea>
...
<input class="btn purp-hov border-0 f16b text-light mt-3" style=" margin-right: 35%; " type=button onClick="location.href='index.php?page=template&amp;view=1&main=1&amp;templateid={$TemplateEdit['templateid']}&amp;styleid={$StyleInfo['id']}'" value="{$lang['ViewOrginaltemplate']}">
<input type="submit" value="{$lang['Save_and_reload']}" name="submit" class="btn purp-hov border-0 f16b text-light mt-3"  />
