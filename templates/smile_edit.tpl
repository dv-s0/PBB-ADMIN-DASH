...
<form action="index.php?page=smile&amp;edit=1&amp;start=1&amp;id={$Inf['id']}" name="myform" method="post">
...
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['smile_short']}</span>
</div>
<input  class=" form-control f12r" type="text" name="short" id="input_short" value="{$Inf['smile_short']}" size="30" />
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['Image_Path']}</span>
</div>
<input  class=" form-control f12r" type="text" name="path" id="input_path" value="{$Inf['smile_path']}" size="30" />
</div>
</div>
<div class="card-footer text-center">
<input class="btn btn-sm purp-hov border-0 f16b text-light mt-2" class="submit" type="submit" value="{$lang['acceptable']}" name="submit" accesskey="s" />
</div>
</div>
</form>
