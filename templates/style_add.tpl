...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=style&amp;control=1&amp;main=1">{$lang['mange_styles']}</a></li>
	    <li class="breadcrumb-item mt-2 active" aria-current="page"> <a href="index.php?page=style&amp;add=1&amp;main=1">{$lang['add_new_style']}</a></li>
...
<form name="importstyle" method="post" enctype="multipart/form-data" action="index.php?page=style&amp;import=1&amp;start=1">
  ...
  <div class="card-header text-center f16b text-primary">{$lang['uploadstyle']}</div>
  ...
  <div class="custom-file">
	<input class="custom-file-input" name="files" type="file" size="40" aria-describedby="inputGroupFileAddon03"/>
    <label class="custom-file-label" for="inputGroupFile03">{$lang['style_upload_XML_file']}</label>
  </div>
</div>
  
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
 <label class="input-group-text  text-wrap   f10b" for="input_name"> {$lang['import_xml_file']}</label>
</div>
  <input class="custom-select" type="text" class="input" name="serverfile" id="it_serverfile" value="setup/PBBoard-style.xml" size="45" dir="ltr" tabindex="1" />
</div>

<div class="input-group input-group-sm mb-3">
  <div class="input-group-prepend">
    <label class="input-group-text  text-wrap  " for="select_captcha_o">{$lang['Would_you_like_to_activate_the_Style']} </label>
	
  </div>
  <select class="custom-select " name="style_on" id="select_style_on">
...
<h6 class="f12b">{$lang['ignore_the_version_style']}</h6>
<div class="custom-control-inline">	
<h6 class="f11r  mr-3 pr-3">{$lang['use_the_style_anyway']}</h6>
<div class="custom-control custom-radio custom-control-inline">
	<input class="custom-control-input" name="anyversion" value="1" id="anyversion" tabindex="1" type="radio">
  <label class="custom-control-label" for="anyversion">{$lang['yes']}</label>
</div>

<div class="custom-control custom-radio custom-control-inline">
	<input class="custom-control-input" name="anyversion" value="0" id="1anyversion" type="radio" tabindex="1" checked="checked">
...
<input name="insert" type="submit" value="{$lang['Import']}" class="btn purp-hov border-0 f16b text-light" style=" margin-right: 45%; " />
</div>
</div>
</div>
