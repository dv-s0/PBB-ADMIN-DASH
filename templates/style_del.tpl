...
<button type="button" class="btn btn-success btn-sm"><a href="index.php?page=style&amp;del=1&amp;start=1&amp;id={$Inf['id']}" style=" color: #fff; text-decoration: none; ">{$lang['yes']}</a></button>
<button type="button" class="btn btn-danger btn-sm"><a href="index.php?page=style&amp;control=1&amp;main=1" style=" color: #fff; text-decoration: none; ">{$lang['no']}</a></button>
