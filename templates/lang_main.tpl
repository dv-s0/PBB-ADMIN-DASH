...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=lang&amp;control=1&amp;main=1">{$lang['langs']}</a></li>
	    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=lang&amp;control=1&amp;main=1">{$lang['mange_langs']}</a></li>
...
<table class="table table-sm table-bordered table-striped  ml-1 f12r" style="width: 99%;">
  <thead>
    <tr  valign="top" align="center" class="f16r">
      ...
      <th scope="col">{$lang['language_name']}</th>
	   <th scope="col">{$lang['edit']}</th>
      <th scope="col">{$lang['Delet']}</th>
	   <th scope="col">{$lang['Download']}</th>
	   <th scope="col">{$lang['Case']}</th>
	   <th scope="col">{$lang['content_dir']}</th>
    </tr>
  </thead>
  <tbody>
{Des::while}{LangList}
<tr valign="top" align="center" class="f13r">
   <td>{$LangList['lang_order']}</td>
	<td>
{if {$LangList['lang_on']}}
{$LangList['lang_title']}
{else}
...
{/if}
	...
	<td><a href="index.php?page=lang&amp;edit=1&amp;main=1&amp;id={$LangList['id']}">
	{$lang['edit']}</a></td>
	<td><a href="index.php?page=lang&amp;del=1&amp;main=1&amp;id={$LangList['id']}">
	{$lang['Delet']}</a></td>
	<td><a href="index.php?page=lang&amp;create_phrase_language=1&amp;download_language=1&amp;id={$LangList['id']}">
	{$lang['Download']}</a></td>
		<td>{if {$LangList['lang_on']}}
	<b>{$lang['activating']}<b>
	{else}
	<b>{$lang['Disabled']}<b>
	{/if}
...
<div class="card bg-light mx-1 mb-3" role="alert">
  <h4 class="card-header text-center f16b text-primary">{$lang['Default_Language']}</h4>
  <div class="card-body">
  
<div class="input-group input-group-sm mb-3">

  <div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_default">{$lang['The_default_language_of_the_Forum']}</label>
</div>
<select class="custom-select" name="default" id="select_default">
{Des::while}{LangDef}
...
<input class="btn btn-sm purp-hov border-0 f16b text-light mt-3" style=" margin-right: 45%; " type="submit" value="{$lang['acceptable']}" name="submit" accesskey="s" />
</div>
</div>
</form>