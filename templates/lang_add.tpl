...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=lang&amp;control=1&amp;main=1">{$lang['langs']}</a></li>
	    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=lang&amp;add=1&amp;main=1">{$lang['add_new_lang']}</a></li>
...
<h4 class="card-header text-center f16b text-primary">{$lang['uploadlang']}</h4>
<div class="card-body">
...
<div class="input-group input-group-sm mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" id="inputGroupFile01">{$lang['upload_XML_file']}</span>
  </div>
  <div class="custom-file">
    <input name="files" type="file"  class="col-lg-8  custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
    <label class="custom-file-label" for="inputGroupFile01">رفع الملفات</label>
  </div>
</div>
...
<div class="input-group input-group-sm mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" id="it_serverfile">{$lang['import_xml_file']}</span>
  </div>
	<input class=" custom-select" type="text" class="input" name="serverfile" id="it_serverfile" value="setup/PBBoard-language.xml" size="45" dir="ltr" tabindex="1" />
</div>
  ...
  <div class="input-group input-group-sm mb-3">
  <div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_lang_on">{$lang['Would_you_like_to_activate_the_language']}</label>
	
  </div>
<select class="custom-select" name="lang_on" id="select_lang_on">
...
<div class="pl-0 ml-0 mb-3">  
<p class="float-left text-left ml-3 pl-0 mr-3 f12rb">{$lang['ignore_the_version_lang']}
<br />
{$lang['use_the_lang_anyway']}</p>
<div class="mb-3"> 	


<div class="custom-control custom-radio custom-control-inline">
	<input class="custom-control-input" name="anyversion" value="1" id="anyversion" type="radio">
  <label class="custom-control-label" for="anyversion">{$lang['yes']}</label>
</div>

<div class="custom-control custom-radio custom-control-inline">
<input class="custom-control-input" name="anyversion" value="0" id="1anyversion" type="radio" checked="checked">
<label class="custom-control-label" for="1anyversion">{$lang['no']}</label>
</div>
 </div>
 </div>
...
<input class="btn btn-sm purp-hov border-0 f16b text-light mt-3" name="insert" type="submit" value="{$lang['Import']}" />
 </div>
  </div>  
 </form>
