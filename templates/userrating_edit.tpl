...
<h4 class="card-header text-center f16b text-primary">{$lang['edit_rating_grade']}</h4>
<div class="card-body f12r">
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['Icon_path_grade']}</span>
</div>
 <textarea class=" form-control f12r" name="rating" rows="1" cols="50" wrap="virtual">{$Inf['rating']}</textarea>
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
...
<hr>
<h4 class="text-danger text-center f16b">{$lang['Help']}</h4>
<small class="f12r">{$lang['HelpText']}</small>
</div>
<div class="card-footer text-center">
<input class="btn btn-sm purp-hov border-0 f16b text-light mt-2" type="submit" value="{$lang['Adopted_amendments']}" name="submit" />
</div>
</div>
</form>
