  ...
  <tbody>
	...
	<tr align="center">
        ...
        <td width="3%" align="center">
		 <div class="custom-control custom-switch">
  <input type="checkbox" class="custom-control-input" id="customSwitch{$AvrList['id']}" name="check[]" value="{$AvrList['id']}">
  <label class="custom-control-label" for="customSwitch{$AvrList['id']}"></label>
</div>
	  </td>
	</tr>
	{/Des::while}
