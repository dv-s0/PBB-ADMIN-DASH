...
<table class="table table-striped border border-top-0 ml-1 f13b" style="width: 99%;">
  <thead>
    <tr class="text-danger f12r">
      <th scope="col">{$lang['Forum_title']}</th>
      <th scope="col">{$lang['Powers']}</th>
	   <th scope="col">{$lang['edit']}</th>
      <th scope="col">{$lang['Delet']}</th>
	   <th scope="col">{$lang['Forum_Order']}</th>
    </tr>
  </thead>
  <tbody>
...
<tr>
	{if {$forum['parent']} == 0}
	<td class="f13r" style=" line-height: 2 ">{$forum['title']}</td>
	{else}
	<td class="f13r" style=" line-height:2">
{if {$forum['is_sub']}}
...
{/if}
	...
	<td style=" line-height: 2.5; "><a href="index.php?page=forums&amp;groups=1&amp;control_group=1&amp;index=1&amp;id={$forum['id']}">{$lang['Powers']}</a></td>
	<td style=" line-height: 2.5; "><a href="index.php?page=forums&amp;edit=1&amp;main=1&amp;id={$forum['id']}">{$lang['edit']}</a></td>
	<td style=" line-height: 2.5; "><a href="index.php?page=forums&amp;del=1&amp;main=1&amp;id={$forum['id']}">{$lang['Delet']}</a></td>
	<td><input class="form-control" type="text" name="order-{$forum['id']}" id="input_order-{$forum['id']}" value="{$forum['sort']}" size="5" /></td>
	{/if}
</tr>
{/Des::foreach}
  </tbody>
