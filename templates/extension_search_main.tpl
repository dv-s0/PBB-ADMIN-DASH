...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2 active" aria-current="page"><a href="index.php?page=extension&amp;search=1&amp;main=1">{$lang['extensions']}</a>
</li>
 <li class="breadcrumb-item mt-2 active" aria-current="page"> {$lang['search_in_attachmint']}
</li>
  </ol>
</nav>


 <div class="alert alert-info text-center f12b mx-1" role="alert">
  <a class="button" href="index.php?page=subject&amp;attach=1&amp;main=1" target="main">{$lang['subjects_attach']}</a>
  </div>
  

<form action="index.php?page=extension&amp;search=1&amp;start=1" method="post">
<div class="card bg-light mx-1 mb-3">
<h4 class="card-header text-center f16b text-primary">{$lang['search_in_attachmint']}</h4>
 <div class="card-body f12r">
   <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['Word_Search']}</span>
</div>
<input class="  form-control f12r" type="text" name="keyword" id="input_keyword" />
</div>
<div class="input-group input-group-sm  mb-3  f12rb">
  <div class="input-group-prepend">
    <label class="input-group-text  text-wrap    f16b" for="select_search_by">{$lang['search_by']}</label>
	
</div>
	<select class=" custom-select" name="search_by" id="select_search_by">
