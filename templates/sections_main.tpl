...
<table class="table table-striped border border-top-0 ml-1 f13b" style="width: 99%;">
  <thead>
    <tr class="f12r">
      <th scope="col">{$lang['Section_title']}</th>
      <th scope="col">{$lang['Powers']}</th>
	   <th scope="col">{$lang['edit']}</th>
      <th scope="col">{$lang['Delet']}</th>
	   <th scope="col">{$lang['Section_ordr']}</th>
    </tr>
  </thead>
  <tbody>
...
{if {$SecList['parent']} == 0}
<tr>
	<td class="f13r">{$SecList['title']}</td>
	<td><a href="index.php?page=sections&amp;groups=1&amp;control_group=1&amp;index=1&amp;id={$SecList['id']}">{$lang['Powers']}</a></td>
	<td><a href="index.php?page=sections&amp;edit=1&amp;main=1&amp;id={$SecList['id']}">{$lang['edit']}</a></td>
	<td><a href="index.php?page=sections&amp;del=1&amp;main=1&amp;id={$SecList['id']}">{$lang['Delet']}</a></td>
	<td class="f13r"><input class="form-control" type="text" name="order-{$SecList['id']}" id="input_order-{$SecList['id']}" value="{$SecList['sort']}" size="5" /></td>
</tr>
{/if}
{/Des::while}
