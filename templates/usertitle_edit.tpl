...
<h4 class="card-header text-center f16b text-primary">{$lang['edit_user_title']}</h4>
<div class="card-body f12r">
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['user_titles']}</span>
</div>
 <textarea class=" form-control f12r" name="title" rows="1" cols="50" wrap="virtual" >{$Inf['usertitle']}</textarea>
</div>
  <div class="input-group input-group-sm mb-3">
<div class="input-group-prepend">
    <span class="input-group-text  text-wrap    f16b" >{$lang['Posts_less_than']}</span>
</div>
<input class=" form-control f12r" type="text" name="posts" value="{$Inf['posts']}" />
</div>
</div>
