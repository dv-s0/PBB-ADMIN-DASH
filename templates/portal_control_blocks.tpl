...
<path style="fill:url(#SVGID_4__44013);" d="M56,32v-2c0-1.103-0.897-2-2-2H42v-2c1.103,0,2-0.897,2-2v-2c0-1.103-0.897-2-2-2h-0.382  l-3.447-6.895C37.829,12.424,37.144,12,36.381,12H13.619c-0.763,0-1.448,0.424-1.791,1.106L8.382,20H8c-1.103,0-2,0.897-2,2v2  c0,1.103,0.897,2,2,2v24c0,1.103,0.897,2,2,2h9h12h9h2h12c1.103,0,2-0.897,2-2V38c1.103,0,2-0.897,2-2v-2C58,32.897,57.103,32,56,32  z M54,30v2H42v-2H54z M13.619,14h22.762l3.001,6H10.618L13.619,14z M8,22h34v2H8V22z M40,26v6v4v2v4h-4v2h4v2h-9v-9  c0-1.654-1.346-3-3-3h-6c-1.654,0-3,1.346-3,3v9h-9v-2h4v-2h-4V26H40z M10,50v-2h9v2H10z M21,50V37c0-0.552,0.448-1,1-1h6  c0.552,0,1,0.448,1,1v13H21z M31,50v-2h9v2H31z M54,50H42V38h12V50z M56,36H42v-2h14V36z"/>
    ...
    <li class="breadcrumb-item mt-2"><a href="index.php">{$lang['Control_Panel']}</a></li>
	 ...
	 <li class="breadcrumb-item mt-2 active" aria-current="page">{$lang['control_blocks']}</li>
  </ol>
</nav>
...
<table class="table table-striped border  border-top-0 rounded  ml-2" style=" width: 98%; ">
  <thead>
    <tr class="f13b text-danger">
      <th scope="col">{$lang['block_title']}</th>
      <th scope="col">{$lang['block_active']}</th>
      <th scope="col">{$lang['block_edit']}</th>
      <th scope="col">{$lang['block_delet']}</th>
	  <th scope="col">{$lang['block_place']}</th>
	  <th scope="col">{$lang['block_order']}</th>
    </tr>
  </thead>
  <tbody>
<?php
	...
	<tr align="center">
		...
		<td >
		<input class="form-control f12r" name="title-<?php echo $get_blocks_row['id'] ?>" id="input_title" value="<?php echo $get_blocks_row['title'] ?>" size="30" type="text">
		</td>
		<td >
      <select class="custom-select f13b "  name="active-<?php echo $get_blocks_row['id'] ?>" id="select_active">
<?php
 ...
 ?>
		...
		<td >
				...
				<select class="custom-select f13b "  name="place_block-<?php echo $get_blocks_row['id'] ?>" id="select_place_block">
<?php
...
<?php
 ...
 ?>
		...
		<td >
				<input class="form-control" type="text" name="sort-<?php echo $get_blocks_row['id'] ?>" id="sort_id" value="<?php echo $get_blocks_row['sort'] ?>" size="1" />
		</td>
	</tr>
		<?php
		}
 ?>
  ...
  <input class="btn purp-hov border-0 f16b text-light mb-2" type="submit" value="{$lang['acceptable']}" name="submit"  style=" margin-right: 45%; "/>
</form>