...
<table class="table table-sm  table-striped table-bordered ml-1 f13b" style="width: 99%;">
  <thead>
    <tr class="f13r" style="color:#004085" align="center">
	 <th scope="col">{$lang['style_name']}</th>
...
<?php
	...
	?>
<tr valign="top">
<td class="text-center f13r"><?php echo $getstyle_row['style_title']?></td>
	<td class="text-center f13r">{$TemplateList['title']}</td>
	<td align="center"><a href="index.php?page=template&amp;edit=1&amp;main=1&amp;templateid={$TemplateList['templateid']}&amp;styleid={$TemplateList['styleid']}">
	{$lang['edit']}</a></td>
	<td  align="center">
<a href="index.php?page=template&amp;del=1&amp;main=1&amp;templateid={$TemplateList['templateid']}&amp;styleid={$TemplateList['styleid']}">{$lang['Delet']}</a></td>
	<td class="f12r" align="center">
	       ...
	       <u><font color="#26084e">{$lang['ViewOrginaltemplate']}</font></u></a>
	       </td>
</tr>
{/Des::while}
{if {$found}}
