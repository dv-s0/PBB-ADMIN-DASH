...
<table class="table table-striped border border-top-0 ml-1 f13b" style="width: 99%;">
  <thead>
    <tr class="f12r" valign="top" align="center">
      <th scope="col">{$lang['style_name']}</th>
      <th scope="col">{$lang['edit_templates']}</th>
    </tr>
  </thead>
  <tbody>
</tr>
...
<tr valign="top" align="center">
	<td class="f13r">{$StyleList['style_title']}</td>
	<td><a href="index.php?page=template&amp;control=1&amp;show=1&amp;id={$StyleList['id']}">
